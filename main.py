...
#Bottom Navigation
    MDBottomNavigation:
        ...
        MDBottomNavigationItem:
            ...
            text:'home'
            Image:
                source:'/storage/emulated/0/Pictures/homebanner.png'
                allow_stretch:True
                keep_ratio:False
                size_hint:1,0.1
...
#IMAGE BANNER                
                img=Image(source='/storage/emulated/0/Pictures/signup.png',size_hint=(1,0.2),allow_stretch=True,keep_ratio=False,pos_hint={'center_x':0.5,'center_y':0.9})
